# -*- coding: utf-8 -*-
#
# bc_voting documentation build configuration file, created by
# TYPO3 extension sphinx on Tue, 31 May 2016 15:43:47 +0200.
#
...
project = u'bc_voting'
copyright = u'2016, Louis Göttertz'
...
htmlhelp_basename = 'bc_votingdoc'
...
latex_documents = [
    ('Index', 'bc_voting.tex', u'bc_voting',
     u'Louis Göttertz', 'manual'),
]
...
texinfo_documents = [
    ('Index', 'bc_voting', u'bc_voting',
     u'Louis Göttertz', 'bc_voting', 'One line description of project.',
     'Miscellaneous'),
]
