...
/**
 * Test case for class \Goettertz\BcVoting\Domain\Model\Voters.
 *
 ...
 */
class VotersTest extends \TYPO3\CMS\Core\Tests\UnitTestCase {
	/**
	 * @var \Goettertz\BcVoting\Domain\Model\Voters
	 */
	protected $subject = NULL;

	protected function setUp() {
		$this->subject = new \Goettertz\BcVoting\Domain\Model\Voters();
	}
	 ...
	 * @test
	 */
	public function getVoterIdReturnsInitialValueForString() {
		$this->assertSame(
			'',
			$this->subject->getVoterId()
		);
	}
	 ...
	 * @test
	 */
	public function setVoterIdForStringSetsVoterId() {
		$this->subject->setVoterId('Conceived at T3CON10');
